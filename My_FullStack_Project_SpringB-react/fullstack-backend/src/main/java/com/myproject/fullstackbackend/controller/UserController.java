...
@RestController
@CrossOrigin("http://localhost:3000")     //to connnect backend with fromtend
public class UserController {
	
	//inject the userrepository interface so use autowired

	@Autowired
	private UserRepository userRepository;
	
	//for posting data use PostMapping
	...
	//for get the data that user enter
